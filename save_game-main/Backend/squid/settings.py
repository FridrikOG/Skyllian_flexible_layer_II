...
INSTALLED_APPS = [
    ...
    'userStatCharacter.apps.UserstatcharacterConfig',
    'reward.apps.RewardConfig',
    'feedback.apps.FeedbackConfig',
    'rewarduser.apps.RewarduserConfig',
    'crypto.apps.CryptoConfig',
    'walletuser.apps.WalletuserConfig',
    'rest_framework',
...
ALLOWED_HOSTS = [
    ...
    "django-env2.eba-kwwanqub.eu-west-2.elasticbeanstalk.com",
    "localhost:3000",
    "localhost",
    "127.0.0.1",
]
